...
class TourDeparture(Stock):
    ...
    class Meta(Stock.Meta):
        ...
        constraints = Stock.Meta.constraints + [models.CheckConstraint(condition=models.Q(ends_at__gt=models.F("starts_at")), name="tour_departure_dates")]
