...
class EventSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Event
        fields = ["id","organizer","title","slug","description","category","venue","address","city","state","start_datetime","end_datetime","capacity","status","image","ticket_types","created_at","updated_at"]
